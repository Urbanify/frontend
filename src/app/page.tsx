...
const highlightCards = [
  ...
  },
  {
    ...
    description: 'Relatorios consolidados, exportacoes e indicadores urbanos.',
  },
  {
    title: 'Servicos ao cidadão',
    description: 'Coleta de lixo, UBSs e informacoes publicas organizadas.',
  },
  {
    title: 'Turismo e visitante',
    description: 'Acesso publico a pontos turisticos e atrativos locais.',
  },
];

const mapPins = [
  { name: 'Centro', status: 'Resolvido', position: 'left-16 top-12' },
  { name: 'Zona Norte', status: 'Em validacao', position: 'right-16 top-20' },
  { name: 'Zona Sul', status: 'Em gestao', position: 'left-1/3 bottom-20' },
  { name: 'Leste', status: 'Reportado', position: 'right-24 bottom-14' },
];

const scopeScenes = [
  {
    tag: 'Gestao urbana e inteligencia',
    title: 'Um centro de comando que transforma dados em acao.',
    description:
      'Dashboard geral, relatorios consolidados, exportacoes rapidas e leitura por mapas ou listas. Tudo conectado para acelerar a decisao.',
    highlight: ['Dashboard vivo', 'Relatorios e exportacoes', 'Mapas + listas'],
      ...
      <div className="relative rounded-2xl border border-border/60 bg-background/70 p-4">
        ...
        <div className="mt-4 rounded-xl border border-border/60 bg-card/90 p-3">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <span className="text-[10px] text-muted-foreground">Em gestao</span>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    title: 'Registro, validacao e obras com transparencia total.',
    description:
      'Do primeiro relato ao fechamento, tudo fica rastreavel. Obras e infraestrutura acompanham prazos, custos e historico publico.',
    highlight: ['Registro com evidencias', 'Validacao responsavel', 'Obras acompanhadas'],
    accent: 'from-accent/30 via-transparent to-transparent',
    visual: (
      <div className="relative rounded-2xl border border-border/60 bg-background/70 p-4">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span>Ciclo de resolucao</span>
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-xl border border-border/60 bg-card/90 p-3">
            ...
            <p className="mt-1 text-sm font-semibold">Iluminacao sem energia</p>
          </div>
          <div className="rounded-xl border border-border/60 bg-card/90 p-3">
  ...
  {
    tag: 'Criminalidade + saude + servicos',
    title: 'Seguranca e cuidado com visao territorial.',
    description:
      'Dados de criminalidade, UBSs, hospitais e horarios de servicos publicos reunidos em uma visao simples para orientar a acao.',
    highlight: ['Analise por regioes', 'UBSs e hospitais', 'Coleta por bairro'],
    accent: 'from-secondary/60 via-transparent to-transparent',
    visual: (
      <div className="relative rounded-2xl border border-border/60 bg-background/70 p-4">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span>Saude e seguranca</span>
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-xl border border-border/60 bg-card/90 p-3">
            <p className="text-xs text-muted-foreground">UBS mais proxima</p>
  ...
  {
    tag: 'Comunicacao, participacao e turismo',
    title: 'A cidade conversa, engaja e valoriza seu territorio.',
    description:
      'Comunicados oficiais, comentarios e modo visitante para promover turismo, atrativos e experiencias locais com acesso publico.',
    highlight: ['Noticias oficiais', 'Comentarios e feedback', 'Turismo sem login'],
    accent: 'from-primary/20 via-transparent to-transparent',
    visual: (
      <div className="relative rounded-2xl border border-border/60 bg-background/70 p-4">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-xl border border-border/60 bg-card/90 p-3">
            ...
            <p className="mt-1 text-sm font-semibold">Nova rota de onibus aprovada</p>
            <p className="text-xs text-muted-foreground">Publicacao com anexos e agenda</p>
          </div>
          <div className="rounded-xl border border-border/60 bg-card/90 p-3">
            <p className="text-xs text-muted-foreground">Participacao cidada</p>
            <p className="mt-1 text-sm font-semibold">412 comentarios ativos</p>
    ...
    <main className={`${spaceGrotesk.className} min-h-svh bg-background text-foreground`}>
        ...
        <section className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-24 pt-6 md:grid md:grid-cols-[1.1fr_0.9fr] md:items-center md:gap-12">
          <div className="flex flex-col gap-6 duration-700 animate-in fade-in slide-in-from-bottom-4">
            <span className="w-fit rounded-full bg-secondary px-4 py-1 text-xs font-semibold uppercase tracking-wider text-secondary-foreground">
              Gestao urbana moderna
            </span>
            <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">
              Transforme reclamacoes em resolucoes com um fluxo claro e humano.
            </h1>
            <p className="text-base text-muted-foreground sm:text-lg">
              Urbanify conecta moradores, fiscais e gestores em um processo auditavel.
            ...
            <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Registro rapido</span>
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Validacao transparente</span>
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Gestao por status</span>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="rounded-3xl border border-border/60 bg-card/90 p-6 shadow-2xl backdrop-blur duration-700 animate-in fade-in slide-in-from-bottom-6">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold">Fluxo de ocorrencia</span>
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-2xl border border-border/60 bg-muted/40 p-4">
                  ...
                  <p className="text-xs text-muted-foreground">Fotos e localizacao anexadas</p>
                </div>
                <div className="rounded-2xl border border-border/60 bg-secondary/40 p-4">
                  ...
                  <p className="mt-2 text-sm font-semibold">Confirmado e atribuido</p>
                  <p className="text-xs text-muted-foreground">Gestao assumiu a resolucao</p>
                </div>
                <div className="rounded-2xl border border-border/60 bg-accent/40 p-4">
                  ...
                  <p className="mt-2 text-sm font-semibold">Reparo concluido</p>
            ...
            <div className="absolute -bottom-6 -right-6 hidden w-48 rounded-2xl border border-border/60 bg-card/90 p-4 shadow-lg md:block">
              ...
              <p className="text-xs text-muted-foreground">-18% no ultimo trimestre</p>
            </div>
          </div>
        </section>
      </div>
        ...
        <div className="grid gap-10 md:grid-cols-[0.9fr_1.1fr]">
          <div className="space-y-4">
            ...
            <p className="text-base text-muted-foreground">
              Cada etapa foi desenhada para reduzir ruido, acelerar decisao e garantir
              que problemas reais virem acoes visiveis.
            </p>
          </div>
          <div className="space-y-4">
      ...
      <section id="escopo" className="mx-auto w-full max-w-6xl px-6 pb-20">
        <div className="flex flex-col gap-10">
          <div className="space-y-3">
            ...
            <p className="text-base text-muted-foreground">
              A contratacao contempla acesso integral e ilimitado, sem cobranca por volume
              de uso, usuarios ou dados. Cada modulo foi desenhado para gerar impacto real.
            </p>
          </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-20">
        <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-semibold">Mapa vivo de ocorrencias</h2>
            <p className="text-base text-muted-foreground">
              Visualize rapidamente onde estao os problemas, o status de cada
              area e quais equipes estao atuando. Tudo em um unico painel,
              sem ruido.
            </p>
            <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Reportado</span>
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Em validacao</span>
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Em gestao</span>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/80 p-6 shadow-2xl">
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              Mapa ilustrativo. Integracao com Google Maps no painel real.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="anuncios" className="mx-auto w-full max-w-6xl px-6 pb-20">
        <div className="grid gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-semibold">Anuncios que valorizam negocios locais</h2>
            <p className="text-base text-muted-foreground">
              Os anuncios dentro do Urbanify ampliam a visibilidade de negocios da cidade,
              com campanhas por territorio, ofertas exclusivas e comunicacao relevante para
              quem usa a plataforma.
            </p>
            <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Promocoes exclusivas</span>
              <span className="rounded-full bg-card px-3 py-1 shadow-sm">Segmentacao por bairros</span>
          ...
          <div className="rounded-3xl border border-border/60 bg-card/80 p-6 shadow-2xl">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border/60 bg-muted/30 p-4">
                <p className="text-xs text-muted-foreground">Promocao local</p>
                <p className="mt-2 text-sm font-semibold">Farmacia Zona Norte</p>
              ...
              <div className="rounded-2xl border border-border/60 bg-muted/30 p-4 sm:col-span-2">
                <p className="text-xs text-muted-foreground">Relatorio de impacto</p>
      ...
      <section id="contato" className="mx-auto w-full max-w-6xl px-6 pb-24">
        <div className="rounded-3xl border border-border/60 bg-secondary/40 p-10 text-center shadow-sm">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-muted-foreground">
            Nosso time esta pronto para ajudar voce a implementar um fluxo completo de
            registro, validacao e gestao de problemas urbanos.
          </p>
