...
export const Playground: Story = {
  ...
  render: (args: any) => (
    <Sheet {...args}>
      <SheetTrigger className="rounded bg-primary p-2 text-primary-foreground">Open Sheet</SheetTrigger>
      <SheetContent side={args.side}>
        ...
        <SheetFooter>
          <SheetClose className="rounded bg-destructive p-2 text-destructive-foreground">Close</SheetClose>
        </SheetFooter>
      </SheetContent>
    </Sheet>
  ),
  ...
  render: args => (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Sheet {...args}>
          <SheetTrigger className="rounded bg-accent p-2 text-accent-foreground">Open Sheet</SheetTrigger>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Sheet {...args}>
          <SheetTrigger className="rounded bg-secondary p-2 text-secondary-foreground">Open Sheet</SheetTrigger>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Sheet {...args}>
          <SheetTrigger className="rounded bg-muted p-2 text-muted-foreground">Open Sheet</SheetTrigger>
